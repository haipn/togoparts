...
public class FSActivity_Search extends Activity_Main implements
		SearchResultFragment.OnFileterSelectedListener {
	...
	void addFragment(Fragment fragment, boolean addToBackStack, int transition) {
		...
		ft.replace(R.id.simple_fragment, fragment,fragment.getClass().getName());
	...
	public void onFilterSelected(String keyword) {
		...
		i.putExtra(Const.QUERY, keyword);
