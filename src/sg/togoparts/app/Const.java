...
public class Const {
	...
	public static String URL_LIST_SEARCH = "http://www.togoparts.com/iphone_ws/mp_list_ads.php?v=1.2&app=free&source=android&%s";
	...
	public static String URL_BIKE_SHOP = "http://www.togoparts.com/iphone_ws/bs_listings.php?source=android&v=1.2&app=free&shopsearch=%s&country=%s&area=%s&open=%s&mechanic=%s&lat=%s&long=%s&sortedby=%s";
	public static String URL_ABOUT = "http://www.togoparts.com/iphone_ws/about-us.php?source=android&v=1.2&app=free";
